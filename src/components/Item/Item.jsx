...
const Item = ({ nombre, precio, stock, img, id }) => {
  return (
    <div key={id} className=" grid border border-gray-200 rounded-lg shadow-md p-4 bg-white justify-items-center">
      <img src={img} alt={nombre} className="w-48 object-cover rounded-md mb-4" />
